...
// ⚡ Bolt: Precomputed 256-byte Lookup Table for CRC-8/CCITT (poly 0x07, init 0x00)
// Replaces expensive programmatic bitwise loops in high-frequency validation paths.
...
uint8_t TallyProtocol::calculateCRC(const TallyPacket& packet) {
    ...
    // ⚡ Bolt: Fast O(1) table lookups replace the 8 inner bitwise loops per byte
