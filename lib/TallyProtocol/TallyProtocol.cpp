...
// Precomputed LUT for CRC-8/CCITT (poly 0x07, init 0x00)
// ⚡ Bolt: Using a 256-byte static Look-Up Table avoids O(N*8) bitwise loops
// and provides an O(1) per-byte calculation for this critical high-frequency validation path.
