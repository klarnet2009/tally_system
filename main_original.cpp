...
static void drawSpinner(int cx, int cy, int r, uint8_t frame) {
  // ⚡ Bolt: Fast-path lookup table avoids expensive trigonometric floating-point operations
  static const float COS_LUT[8] = {1.0f, 0.7071f, 0.0f, -0.7071f, -1.0f, -0.7071f, 0.0f, 0.7071f};
  static const float SIN_LUT[8] = {0.0f, 0.7071f, 1.0f, 0.7071f, 0.0f, -0.7071f, -1.0f, -0.7071f};
  for (int i = 0; i < 8; i++) {
