...
## 2024-05-20 - Fast CRC Calculation using LUTs
**Learning:** Computing CRC bytes iteratively using nested bitwise loops inside high-frequency serialization/deserialization routines introduces unnecessary CPU overhead on embedded devices.
